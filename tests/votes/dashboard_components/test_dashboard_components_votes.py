...
def test_votes_component(module_factory):
    ...
    assert component.get_base_url(module_pb3) == \
           reverse('a4dashboard:voting-tokens',
                   kwargs={'module_slug': module_pb3.slug})
...
def test_votes_generate_votes_component(module_factory):
    ...
    assert component.get_base_url(module_pb3) == \
           reverse('a4dashboard:voting-token-generation',
                   kwargs={'module_slug': module_pb3.slug})
