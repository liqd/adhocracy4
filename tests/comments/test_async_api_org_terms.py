...
def test_agreement_save_with_comment_create(
...
def test_admin_agreement_save_with_comment_update(
        comment, apiclient, admin):
...
def test_agreement_info(
        mock_provider, user, another_user, apiclient, question_ct,
