...
def test_category_filter(apiclient, question, comment_factory, user):
    ...
    comment_factory(pk=1, content_object=question,
                    comment_categories='QUE, REM')
    comment_factory(pk=2, content_object=question,
                    comment_categories='QUE')
    comment_factory(pk=3, content_object=question,
                    is_blocked=True, comment_categories='QUE')
    comment_factory(pk=4, content_object=question,
                    is_censored=True, comment_categories='REM')
    comment_factory(pk=5, content_object=question,
                    is_removed=True, comment_categories='QUE, REM')
    comment_factory(pk=6, content_object=question,
                    comment_categories='REM')
    comment = comment_factory(pk=7, content_object=question,
                              comment_categories='QUE')
...
@pytest.mark.django_db
def test_ordering_filter(apiclient, question, comment_factory, rating_factory,
                         user):
    question_ct = ContentType.objects.get_for_model(Question)

    comment1 = comment_factory(pk=1, content_object=question)
    comment2 = comment_factory(pk=2, content_object=question,
                               is_moderator_marked=True)
    comment3 = comment_factory(pk=3, content_object=question)
    comment4 = comment_factory(pk=4, content_object=question,
                               is_moderator_marked=True)
