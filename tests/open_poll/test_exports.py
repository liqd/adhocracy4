...
from adhocracy4.open_poll.exports import OpenPollCommentExportView
from adhocracy4.open_poll.exports import OpenPollExportView
from adhocracy4.ratings.models import Rating


@pytest.mark.django_db
def test_poll_comment_export_view(open_poll, comment_factory, rating_factory):

    comment_1 = comment_factory(content_object=open_poll)
    ...
    comment_export_view = OpenPollCommentExportView(kwargs={"module": open_poll.module})
...
def test_poll_export_view(
    ...
    choice_question = question_factory(poll=open_poll, multiple_choice=True, weight=1)
    open_question = question_factory(poll=open_poll, is_open=True, weight=2)
    ...
    export_view = OpenPollExportView(kwargs={"module": open_poll.module})
