...
from adhocracy4.open_poll.models import Answer
from adhocracy4.open_poll.models import OtherVote
from adhocracy4.open_poll.models import Vote
from adhocracy4.open_poll.phases import VotingPhase
...
def test_anonymous_user_can_not_vote(
    ...
    url = reverse("open_poll-vote", kwargs={"pk": poll.pk})
...
def test_other_choice_vote_created(user, question, apiclient, choice_factory):
    ...
    url = reverse("open_poll-vote", kwargs={"pk": question.poll.pk})
...
def test_answer_created(user, open_question, apiclient):
    ...
    url = reverse("open_poll-vote", kwargs={"pk": open_question.poll.pk})
...
def test_validate_choices(apiclient, user, question_factory, choice_factory):
    ...
    url = reverse("open_poll-vote", kwargs={"pk": question1.poll.pk})
    ...
    url = reverse("open_poll-vote", kwargs={"pk": question2.poll.pk})
...
def test_validate_question_belongs_to_poll(
    ...
    url = reverse("open_poll-vote", kwargs={"pk": poll_2.pk})
