...
@pytest.mark.django_db
def test_module_running_time_left(project_factory, module_factory, phase_factory):
...
def test_module_running_time_left_abbreviated(
    ...
    with freeze_time("2013-01-01 18:30:00 UTC"):
        assert project.module_running_time_left_abbreviated == [1, "D", "days"]
        assert project2.module_running_time_left_abbreviated == [0, "S", "seconds"]
        assert project3.module_running_time_left_abbreviated is None
