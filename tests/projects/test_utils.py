...
def test_module_cluster_mixin_modules_overlapping(phase_factory, module_factory):
...
@pytest.mark.django_db
def test_module_cluster_mixin_modules_successively(phase_factory, module_factory):
