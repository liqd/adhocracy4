...
def test_view_project_draft(user_factory, group_factory, organisation, project_factory):
...
@pytest.mark.django_db
def test_view_project_live(user_factory, group_factory, organisation, project_factory):
    anonymous = AnonymousUser()
    user = user_factory()
    initiator = user_factory()
    moderator = user_factory()
...
@pytest.mark.django_db
def test_view_archived_project(
...
@pytest.mark.django_db
def test_view_semiprivate_project(
    user_factory, group_factory, organisation, project_factory
):
    anonymous = AnonymousUser()
    user = user_factory()
