...
@pytest.mark.django_db
def test_rule_project_draft(offline_event_factory, user_factory, group_factory, user):
...
@pytest.mark.django_db
def test_rule_project_archived(
    offline_event_factory, user_factory, group_factory, user
):
