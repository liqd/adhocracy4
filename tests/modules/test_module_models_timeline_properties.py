...
def test_is_in_cluster_one_module(module_factory, project):
    ...
    assert module.get_detail_url == module.project.get_absolute_url()


@pytest.mark.django_db
def test_is_in_cluster_overlapping_module(phase_factory, module_factory, project):
    ...
    assert module1.get_detail_url == module1.get_absolute_url()
    assert module2.get_detail_url == module2.get_absolute_url()
...
def test_is_in_cluster_overlapping_module_and_timeline(
    ...
    assert module1.get_detail_url == module1.get_absolute_url()
    assert module2.get_detail_url == module2.get_absolute_url()
    assert module3.get_detail_url == "{}?initialSlide={}".format(
        module3.project.get_absolute_url(), module3.get_timeline_index
    )
