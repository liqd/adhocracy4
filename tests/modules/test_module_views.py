...
def test_detail_view_module_active(client, phase):
    module = phase.module
...
@pytest.mark.django_db
def test_detail_view_before_module_active(client, phase):
    module = phase.module
    module_url = reverse('module-detail', args=[module.slug])
...
@pytest.mark.django_db
def test_detail_view_after_module_active(client, phase):
    module = phase.module
    module_url = reverse('module-detail', args=[module.slug])
