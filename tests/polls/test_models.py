...
def test_question_queryset(
    ...
    question2 = question_factory(poll=poll, multiple_choice=True, label="question2")
...
@pytest.mark.django_db
def test_get_absolute_url(poll, question, vote, answer, choice, other_vote):

    assert poll.get_absolute_url() == poll.project.get_absolute_url()
