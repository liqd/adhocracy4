...
from adhocracy4.categories.filters import CategoryAliasFilter
...
@pytest.mark.django_db
def test_category_alias_filter(rf, module_factory, category_factory):
    """
    Check that the fk-queryset is filter by the module property of the view.
    """
    module = module_factory()
