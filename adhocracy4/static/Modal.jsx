...
export const Modal = (props) => {
  let dismiss = props.dismissOnSubmit ? 'modal' : 'false'
  return (
    <div className="modal fade" id={props.name} tabIndex="-1"
      role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div className="modal-dialog modal-lg" role="document">
        <div className="modal-content">
          <div className="modal-header">
            <button className="close" aria-label={props.abort}
          ...
          <div className="modal-footer">
            <div className="row">
              <button className="submit-button" data-dismiss={dismiss}
                onClick={props.submitHandler}>{props.action}</button>
            </div>
            <div className="row">
              <button className="cancel-button" data-dismiss="modal"
                onClick={props.closeHandler}>{props.abort}</button>
            </div>
          </div>
          }
        </div>
