...
const translated = {
  ...
  deletedyByCreatorOn: django.gettext('Deleted by creator on TEST'),
  deletedByModeratorOn: django.gettext('Deleted by moderator on TEST'),
  blockedByModeratorOn: django.gettext('Blocked by moderator on TEST'),
