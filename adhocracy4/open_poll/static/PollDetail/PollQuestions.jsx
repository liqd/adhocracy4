...
class PollQuestions extends React.Component {
  ...
  getVoteButton () {
    const isAuthenticated = this.state.questions.length > 0 && (this.state.questions[0].authenticated || this.state.allowUnregisteredUsers)
  ...
  getPollData () {
    api.openPoll.get(this.props.pollId)
