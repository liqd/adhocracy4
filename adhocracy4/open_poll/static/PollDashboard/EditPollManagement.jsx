...
export const EditPollManagement = (props) => {
  ...
  useEffect(() => {
    api.openPoll.get(props.pollId).done(result => {
  ...
  const handleSubmit = (e) => {
    ...
    api.openPoll.change(data, props.pollId)
      .done((data) => {
  ...
  return (
    ...
    >
      <div>
        <label htmlFor="scales">Allow unregistered user to vote</label>
