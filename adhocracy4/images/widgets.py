...
class ImageInputWidget(widgets.ClearableFileInput):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        return loader.render_to_string(self.widget_template_name, context)
    ...
    def value_from_datadict(self, data, files, name):
        ...
        upload.
        """
        file_value = super(widgets.ClearableFileInput, self).value_from_datadict(
            data, files, name
        )
        checkbox_value = widgets.CheckboxInput().value_from_datadict(
