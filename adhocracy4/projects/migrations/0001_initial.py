        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_public",
                    models.BooleanField(
                        help_text="Please indicate who should be able to participate in your project. Teasers for your project including title and short description will always be visible to everyone",
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        help_text="The image will be shown as a decorative background image. It must be min. 1300px wide and 600px tall. Allowed file formats are .jpg and .png. The file size should be max. 2 MB.",
                    ),
                ),
                (
                    "moderators",
                    models.ManyToManyField(
                        to=settings.AUTH_USER_MODEL, related_name="project_moderator"
                    ),
                ),
                (
                    "organisation",
                    models.ForeignKey(
                        to=settings.A4_ORGANISATIONS_MODEL, on_delete=models.CASCADE
                    ),
                ),
                (
                    "participants",
