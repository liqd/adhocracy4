  ...
  return (
    <div className="dropdown editpoll__dropdown">
      ...
      <div className="dropdown-menu">
        <button key="1" className="dropdown-item" type="button" onClick={props.handleToggleMulti}>{translated.multi}</button>
        <button key="2" className="dropdown-item" type="button" onClick={props.handleToggleOpen}>{translated.open}</button>
      </div>
    </div>
  )
}
