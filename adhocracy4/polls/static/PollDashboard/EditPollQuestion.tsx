...
interface EditPollQuestionProps {
  ...
  onChoiceLabelChange?: (index: number, newLabel: string) => void
  onMultipleChoiceChange?: (isMultipleChoice: boolean) => void
  onDeleteChoice?: (choiceIndex: number) => void
  onHasOtherChoiceChange?: (hasOtherChoice: boolean) => void
  onAppendChoice?: (hasOtherChoice: boolean) => void
        ...
        <div className="form-group editpoll__question--border">
          ...
          >
            ...
            <textarea
              ...
              onChange={(e) => { props.onLabelChange && props.onLabelChange(e.target.value) }}
          ...
          <div className="form-check">
            <label className="form-check__label" htmlFor={'id_questions-' + props.id + '-multiple_choice'}>
              <input
                ...
                onChange={(e) => { props.onMultipleChoiceChange && props.onMultipleChoiceChange(e.target.checked) }}
              />
              &nbsp;
          ...
          <div className="form-check">
            <label className="form-check__label" htmlFor={'id_questions-' + props.id + '-is_other_choice'}>
              <input
                ...
                onChange={(e) => { props.onHasOtherChoiceChange && props.onHasOtherChoiceChange(e.target.checked) }}
                  ...
                  : (
                    <div key={key}>
                      <EditPollChoice
                        ...
                        choiceId={choice.id}
                        onDelete={() => props.onHasOtherChoiceChange && props.onHasOtherChoiceChange(false)}
                        undeletable={props.question.choices.length < 3}
                        isOther
                      />
                    </div>
          ...
          <div className="editpoll__btns--question">
            <button
              ...
              onClick={() => props.onAppendChoice && props.onAppendChoice(hasOtherOption)}
              type="button"
            >
