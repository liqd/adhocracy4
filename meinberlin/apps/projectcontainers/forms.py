...
HELP_TEXTS = {
    ...
    "tile_image": _("The image will be shown in the container tile."),
}
...
class ContainerProjectsForm(ProjectDashboardForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields["projects"].queryset = (
            projects.filter(projectcontainer=None)
            .filter(
                Q(containers=self.instance)
                | (
                    Q(containers=None) & Q(is_archived=False) & Q(access=Access.PUBLIC)
