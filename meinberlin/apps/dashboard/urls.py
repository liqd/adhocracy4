...
urlpatterns = [
    ...
    re_path(r'^newsletters/(?P<organisation_slug>[-\w_]+)/create/$',
            newsletter_views.DashboardNewsletterCreateView.as_view(),
            name='newsletter-create'),
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/containers/$',
            container_views.ContainerListView.as_view(),
            name='container-list'),
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/bplans/$',
    ...
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/plans/$',
            plan_views.DashboardPlanListView.as_view(),
            name='plan-list'),
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/plans/create/$',
            plan_views.DashboardPlanCreateView.as_view(),
            name='plan-create'),
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/plans/export/$',
            DashboardPlanExportView.as_view(),
            name='plan-export'),
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)'
            r'/plans/(?P<pk>\d+)/$',
    ...
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)'
            ...
            name='plan-delete'),
    re_path(r'^publish/plan/(?P<pk>[-\w_]+)/$',
    ...
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/blueprints/'
            r'external-project/$',
    ...
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/projects/$',
            views.DashboardProjectListView.as_view(),
            name='project-list'),
    re_path(r'^organisations/(?P<organisation_slug>[-\w_]+)/projects/create$',
