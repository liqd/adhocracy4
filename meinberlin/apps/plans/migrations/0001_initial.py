    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point', adhocracy4.maps.fields.PointField(help_text='Click inside marked area on the map to set a marker. Drag and drop the marker to change its place. Alternatively you can use the search field to search for an address.', verbose_name='Where can the plan be located on a map?')),
